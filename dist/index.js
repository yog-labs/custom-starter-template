...
exports.deniedWords = exports.approvedWords = void 0;
exports.approvedWords = [
    'approved',
    'approve',
    'lgtm',
    'goahead',
...
const constants_2 = __nccwpck_require__(5105);
...
const actionContext = {
    ...
    assignees: core_1.default.getInput('approvers').split(','),
    token: core_1.default.getInput('secret'),
    timeout: ~~core_1.default.getInput('timeout'),
    title: core_1.default.getInput('issue_title'),
    body: core_1.default.getInput('body_message'),
    labels: core_1.default.getInput('labels').split('')
};
const repoUrl = `https://api.github.com/repos/${actionContext.org}/${actionContext.repo}`;
let timeTrigger;
let timeDurationCheck;
function createApprovalIssue() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield (0, axios_1.default)(createIssueRequest)
            .then(res => {
...
function updateApprovalIssueOnComments() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield (0, axios_1.default)(commentListRequest)
            .then((res) => __awaiter(this, void 0, void 0, function* () {
            if (res.data.length > 0) {
                if (constants_1.approvedWords.includes(res.data[res.data.length - 1].body.toLowerCase())) {
                    console.log(`${actionContext.assignees} Approved to proceed.`);
                    yield closeIssue();
                }
                else if (constants_2.deniedWords.includes(res.data[res.data.length - 1].body.toLowerCase())) {
...
function closeIssue() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield (0, axios_1.default)(closeIssueRequest)
            .then(cresp => {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield createApprovalIssue();
            timeTrigger = setInterval(updateApprovalIssueOnComments, 5000);
            timeDurationCheck = setTimeout(function () {
                return __awaiter(this, void 0, void 0, function* () {
